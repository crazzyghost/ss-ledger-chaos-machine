...
import com.softspark.chaos.flow.model.v1.TreasuryPrefundCompletedEventData;
...
/**
 * Builds {@link EventEnvelope} payloads for {@link FlowType#TREASURY_PREFUND_COMPLETED} events.
 *
 * <p>Slots: {@code source} (system SETTLEMENT_ACCOUNT), {@code destination} (system
 * PLATFORM_FLOAT_MTN).
 */
@Component
public class TreasuryPrefundFlowBuilder implements FlowBuilder<TreasuryPrefundCompletedEventData> {

  private final TopicCatalog topicCatalog;

  public TreasuryPrefundFlowBuilder(TopicCatalog topicCatalog) {
    this.topicCatalog = topicCatalog;
  }

  @Override
  public FlowType type() {
    return FlowType.TREASURY_PREFUND_COMPLETED;
  }
  ...
  @Override
  public EventEnvelope<TreasuryPrefundCompletedEventData> build(
    ...
    var data =
        new TreasuryPrefundCompletedEventData(
            f.getRequired("prefund_request_id"),
    ...
    String idempotencyKey = "treasury-prefund-completed:" + ctx.eventId();
