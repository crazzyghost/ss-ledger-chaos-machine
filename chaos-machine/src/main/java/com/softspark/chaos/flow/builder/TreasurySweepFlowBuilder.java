...
import com.softspark.chaos.flow.model.v1.TreasurySweepCompletedEventData;
...
/**
 * Builds {@link EventEnvelope} payloads for {@link FlowType#TREASURY_SWEEP_COMPLETED} events.
 *
 * <p>Slots: {@code source} (system PLATFORM_FLOAT_MTN), {@code destination} (system
 * SETTLEMENT_ACCOUNT).
 */
@Component
public class TreasurySweepFlowBuilder implements FlowBuilder<TreasurySweepCompletedEventData> {

  private final TopicCatalog topicCatalog;

  public TreasurySweepFlowBuilder(TopicCatalog topicCatalog) {
    this.topicCatalog = topicCatalog;
  }

  @Override
  public FlowType type() {
    return FlowType.TREASURY_SWEEP_COMPLETED;
  }
  ...
  @Override
  public EventEnvelope<TreasurySweepCompletedEventData> build(
    ...
    var data =
        new TreasurySweepCompletedEventData(
            f.getRequired("sweep_request_id"),
    ...
    String idempotencyKey = "treasury-sweep-completed:" + ctx.eventId();
