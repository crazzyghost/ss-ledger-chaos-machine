...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleHttpException(HttpException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ApiError> handleValidationException(
        ...
        String requestId = getRequestId();
        List<ErrorDescription> errors = ex.getBindingResult()
                .getFieldErrors()
                .stream()
                .map(this::toErrorDescription)
                .toList();
