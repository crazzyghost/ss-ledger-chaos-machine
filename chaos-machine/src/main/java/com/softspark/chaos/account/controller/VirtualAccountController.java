...
public class VirtualAccountController {
    ...
    @Operation(summary = "Create a virtual account",
            description = "Creates a new virtual account, optionally linking to an organization and announcing via Kafka")
     ...
     */
    @GetMapping("/{vaId}")
    @Operation(summary = "Get a virtual account",
     ...
     */
    @GetMapping
    @Operation(summary = "List virtual accounts",
    ...
    public ResponseEntity<PageResponse<VirtualAccountResponse>> listVirtualAccounts(
        ...
        var result = virtualAccountService.listVirtualAccounts(
    ...
    @Operation(summary = "Publish virtual account to Kafka",
