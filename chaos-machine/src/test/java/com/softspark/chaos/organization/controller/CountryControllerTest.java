...
class CountryControllerTest {
  ...
  class CreateCountryTests {
    ...
    void blankNameReturns400() throws Exception {
      var req = new CreateCountryRequest("", "GH", null, null);
    ...
    void isoCodeTooShortReturns400() throws Exception {
      var req = new CreateCountryRequest("Ghana", "G", null, null);
    ...
    void isoCodeTooLongReturns400() throws Exception {
      var req = new CreateCountryRequest("Ghana", "GHAN", null, null);
    ...
    void invalidStatusReturns400() throws Exception {
      var req = new CreateCountryRequest("Ghana", "GH", "NOT_A_STATUS", null);
